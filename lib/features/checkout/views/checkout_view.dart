    ...
    return BlocBuilder<CartCubit,CartState>(
      builder: (context, state) {
        if(state is CartLoaded){
          ...
          final total =
          context.read<CartCubit>().getTotalPrice(cart);
          double order = double.parse(total.toString());
          double taxPercent = 0.10;   // 10%
          double deliveryPercent = 0.05; // 5%

          double taxes = order * taxPercent;
          double fees = order * deliveryPercent;

          double totalPrice = order + taxes + fees;
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        CustomText(text: '\$ $totalPrice', size: 24),
                      ],
                    ),
                    CustomButton(
                      text: 'Pay Now',

...
class CategoriesModel extends CategoriesEntity {
  CategoriesModel({int? code, String? message, List<CategoryModel>? data})
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      "message": message,
      "data": data != null
          ? List<dynamic>.from(data!.map((x) => (x as CategoryModel).toJson()))
          : [],
    };
  }
}
...
class CategoryModel extends CategoryEntity {
  CategoryModel({int? id, String? name}) : super(id: id, name: name);

...
class AuthModel extends AuthEntity {
  AuthModel({String? code, String? message, DataModel? data})
...
class DataModel extends DataEntity {
  DataModel({String? token, String? name, String? email, String? image})
    : super(token: token, name: name, email: email, image: image);
